...
export function stubOps() {
  ...
  return [
    ...
    A("Q-Legal", "Legal Repository", "Your whole contract estate, asked in plain English. Every file is read once (Munshi vision-OCR for scans) into a transcript, a concise key and two wikis — contents and clauses — then answers cite the document and the §. Write a standing question once and it's answered for every contract, with renewal and obligation deadlines tracked. SharePoint stays the source of truth; this only reads.", "/qlegal.html", "live"),
