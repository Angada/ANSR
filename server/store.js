...
const DEFAULT_CONFIG = {
  ...
  pipelines: {
    ...
    "mint-munshi-parse": { id: "mint-munshi-parse", product: "Mint", name: "Munshi Parse", kind: "hybrid",
      description: "Read the whole contract corpus (SOW + amendments + clarifications) → atomic, clause-referenced rule-chips. Munshi method — re-parse on change, preserve human-confirmed chips.",
      provider: "anthropic", model: "claude-opus-4-8", skills: ["qansr-contract-intake", "munshi"], enabled: true,
      prompt: "You are Munshi. Read the whole contract corpus and return STRICT JSON {\"chips\":[{\"box_type\":\"company|legal|payment_terms|commercial_terms|billing_rules|caveats|flags\",\"key\":\"stable atomic key\",\"value\":{...},\"clause_ref\":\"§..\",\"weight\":0-1}]}. Each rule/fact is ONE atomic chip with its clause ref. Never invent — only what the text supports." },
